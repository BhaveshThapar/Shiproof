# Shiproof Pre-flight — GitHub Action
...
This is a thin composite wrapper around [`@shiproof/cli`](https://www.npmjs.com/package/@shiproof/cli):
...
| `version`      | `^0.1.0` | npm version range of `@shiproof/cli` to run.                                                     |

## What you get

- A **`## Shiproof pre-flight`** section in the job summary (`$GITHUB_STEP_SUMMARY`) with
